...
<form name="regForm" method="post" action="modifyProc.jsp">
    <table border="1">
        ...
        <tr>
            ...
            <input type="text" name="phone3" size="5" value="<%=vo.getPhone3()%>"/></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><input type="text" name="address1" value="<%=vo.getAddress1()%>"/></td>
        </tr>
        <tr>
            <td align="right">주소2 : </td>
            <td><input type="text" name="address2" value="<%=vo.getAddress2()%>"/></td>
        </tr>
        <tr>
